...
public class CreditBundleStore : MonoBehaviour
{
    ...
    {
        Initialize();
        SP.GetWorldCurrencyInfo(ReceivedWorldCurrencyInfo);
    }

    public void ReceivedWorldCurrencyInfo(WorldCurrencyInfo worldInfo)
    {
        Debug.Log("World currency info//  FreeCurrencyName: " + worldInfo.FreeCurrencyName + "  FreeCurrencyImage: " + worldInfo.FreeCurrencyImage + "   PaidCurrencyName: " + worldInfo.PaidCurrencyName + "   PaidCurrencyImage: " + worldInfo.PaidCurrencyImage);
    }
